...
const AuthNavbar = () => {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-slate-800 bg-[#111621]/92 backdrop-blur-md">
      <div className="mx-auto flex h-20 w-full max-w-[1440px] items-center justify-between px-4 sm:px-6 lg:px-8">
        <Link to="/" className="flex items-center gap-3">
          ...
          <p className="text-2xl font-bold leading-none text-white">BookNest</p>
        </Link>
