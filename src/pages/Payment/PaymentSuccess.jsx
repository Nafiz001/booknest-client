...
const PaymentSuccess = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-[#111621] text-slate-100">
      <div
      ...
      <header className="sticky top-0 z-50 border-b border-slate-800 bg-[#111621]/90 px-6 py-4 backdrop-blur-md">
        <div className="mx-auto flex w-full max-w-[1080px] items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <button className="inline-flex h-10 w-10 items-center justify-center rounded-full text-slate-300 transition-colors hover:bg-slate-800">
        ...
        <div className="w-full max-w-[800px] space-y-10">
          <section className="flex flex-col items-center gap-6 text-center">
            ...
            <div className="max-w-[520px] space-y-2">
              <h1 className="text-3xl font-bold tracking-tight text-white md:text-4xl">Order Confirmed!</h1>
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              ...
              <Link
                to="/all-books"
                className="inline-flex h-12 items-center justify-center gap-2 rounded-full border border-slate-700 bg-transparent px-8 text-sm font-semibold text-slate-200 transition-colors hover:bg-slate-800"
              >
                Continue Shopping
              </Link>
            </div>
          ...
          <section className="overflow-hidden rounded-xl border border-slate-700 bg-slate-800/55 shadow-lg">
            <div className="flex flex-col gap-4 border-b border-slate-700 p-6 sm:flex-row sm:items-center sm:justify-between">
              <div>
                <p className="mb-1 text-xs font-semibold uppercase tracking-wider text-slate-500">Order Number</p>
                <p className="font-mono text-lg font-medium text-white">{receiptMeta.orderNumber}</p>
              </div>
            ...
            <div className="h-1.5 w-full bg-slate-900/60">
              <div className="h-full w-1/4 rounded-r-full bg-primary"></div>
            </div>

            <div className="p-6">
              <h3 className="mb-4 text-sm font-semibold text-white">Items in your order</h3>
                ...
                {[
                  ...
                  <div key={item.title} className="flex gap-4">
                    ...
                    <div className="flex flex-col justify-center">
                      ...
                      <p className="mt-2 text-xs font-medium text-slate-200">{item.price}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="border-t border-slate-700 bg-slate-900/45 p-6">
              <div className="space-y-3">
                <div className="flex justify-between text-sm">
                  <span className="text-slate-400">Subtotal</span>
                  <span className="font-medium text-slate-200">$45.49</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-slate-400">Shipping</span>
                  <span className="font-medium text-slate-200">$5.90</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-slate-400">Tax</span>
                  <span className="font-medium text-slate-200">$3.64</span>
                </div>
                <div className="my-2 h-px bg-slate-700"></div>
                <div className="flex items-center justify-between">
                  <span className="text-base font-semibold text-white">Total Paid</span>
                  <span className="text-xl font-bold text-white">$55.03</span>
                </div>
              </div>
            </div>
          </section>
