...
const Payment = () => {
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-[#111621]">
        <div className="text-center">
          ...
          <p className="mt-4 text-slate-400">Loading payment...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-[#111621] text-slate-100">
      <header className="sticky top-0 z-50 border-b border-slate-800 bg-[#111621]/95 px-6 py-4 backdrop-blur">
      ...
      <main className="mx-auto flex w-full max-w-[1440px] flex-col lg:flex-row">
        <section className="flex-1 px-6 py-10 lg:px-20 lg:py-14">
          <div className="mx-auto max-w-xl">
            <button
              ...
              className="mb-7 inline-flex items-center gap-2 text-sm font-medium text-slate-400 transition-colors hover:text-primary"
            >
            ...
            <nav aria-label="Progress" className="mb-8">
              <ol className="flex items-center gap-4 text-sm font-medium">
                ...
                <li className="h-px w-8 bg-slate-700"></li>
                <li className="flex items-center gap-2 text-primary">
                ...
                <li className="flex items-center gap-2 text-slate-500">
                  <span className="flex h-6 w-6 items-center justify-center rounded-full border border-slate-700 text-xs">3</span>
                  Confirmation
                </li>
              </ol>
            </nav>
            ...
            <p className="mt-2 text-slate-400">Complete your purchase securely. All transactions are encrypted.</p>
            ...
            <div className="mt-8 space-y-4">
              ...
              <label className="block cursor-pointer rounded-lg border border-slate-700 bg-slate-800/70 p-4 transition-colors hover:border-primary/50">
                <div className="flex items-center gap-3">
            ...
            <div className="mt-8 space-y-5">
              <div>
                <label className="mb-1.5 block text-sm font-medium text-slate-300">Name on Card</label>
                <input
                  type="text"
                  placeholder={order.name || 'John Doe'}
                  className="h-11 w-full rounded-lg border border-slate-700 bg-slate-800 px-3 text-sm text-slate-100 placeholder:text-slate-500 outline-none focus:border-primary focus:ring-2 focus:ring-primary/30"
                />
              </div>
              <div>
                <label className="mb-1.5 block text-sm font-medium text-slate-300">Card Number</label>
                <input
                  type="text"
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="mb-1.5 block text-sm font-medium text-slate-300">CVC</label>
                  <input
                    type="text"
                    placeholder="123"
                    className="h-11 w-full rounded-lg border border-slate-700 bg-slate-800 px-3 text-sm text-slate-100 placeholder:text-slate-500 outline-none focus:border-primary focus:ring-2 focus:ring-primary/30"
              ...
              <label className="inline-flex items-center gap-3 text-sm text-slate-400">
                <input type="checkbox" className="h-4 w-4 rounded border-slate-600 bg-slate-800 text-primary focus:ring-primary" />
        ...
        <aside className="w-full border-t border-slate-800 bg-slate-900/40 p-6 lg:w-[480px] lg:min-h-[calc(100vh-73px)] lg:border-l lg:border-t-0 lg:p-10">
          <div className="sticky top-24">
            ...
            <div className="mb-8 flex gap-4">
              ...
              <div className="flex flex-col justify-center">
                <h3 className="text-base font-bold text-white leading-tight">{order.bookTitle}</h3>
                <p className="mt-1 text-sm text-slate-400">{order.name || user.displayName}</p>
                <p className="mt-3 text-sm font-medium text-slate-200">${totalDue}</p>
            ...
            <div className="space-y-4 border-t border-slate-800 pt-6 text-sm">
              <div className="flex justify-between">
                ...
                <span className="font-medium text-white">${totalDue}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-400">Shipping (Premium)</span>
            ...
            <div className="mt-6 flex items-center justify-between border-t border-slate-800 pt-6">
              ...
              <span className="text-2xl font-bold tracking-tight text-white">${totalDue}</span>
            </div>

            <div className="mt-8 flex gap-3 rounded-lg border border-primary/20 bg-primary/10 p-4">
              <Check className="mt-0.5 h-5 w-5 shrink-0 text-primary" />
              <div>
                <h4 className="text-sm font-semibold text-white">BookNest Guarantee</h4>
