...
const DashboardLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-blue-50 to-slate-100 text-slate-900 dark:from-[#050d1f] dark:via-[#071636] dark:to-[#050d1f] dark:text-slate-100">
      <div className="flex">
        <aside className="sticky top-0 hidden h-screen w-72 flex-col border-r border-slate-200 bg-white/90 p-4 backdrop-blur-xl dark:border-slate-800 dark:bg-[#030b1c]/95 lg:flex">
          <div className="flex h-full flex-col justify-between">
            <div>
              <div className="mb-6 flex items-center gap-3 rounded-xl border border-slate-200 bg-white px-3 py-2 shadow-sm dark:border-slate-700 dark:bg-slate-900/70">
              ...
              <div className="mb-5 rounded-xl border border-slate-200 bg-gradient-to-r from-slate-50 to-white p-3 dark:border-slate-700 dark:from-slate-900/85 dark:to-slate-900/65">
            ...
            <div className="space-y-2">
              <ThemeToggle className="w-full justify-center rounded-xl" iconClassName="h-4 w-4" />
              <Link
                to="/"
                className="inline-flex w-full items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-sm font-semibold text-slate-700 transition-colors hover:border-primary/40 hover:text-slate-900 dark:border-slate-700 dark:bg-slate-900/60 dark:text-slate-200 dark:hover:text-white"
              >
              ...
              <button
                ...
                className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-primary/10 px-3 py-2.5 text-sm font-semibold text-primary transition-colors hover:bg-primary/15 dark:bg-[#0b2c67] dark:text-primary dark:hover:bg-[#133781]"
              >
        ...
        {isSidebarOpen && (
          <div className="fixed inset-0 z-50 lg:hidden">
            ...
            <aside className="absolute left-0 top-0 h-full w-72 animate-slide-right bg-white/95 p-4 backdrop-blur-xl dark:bg-[#030b1c]/95">
        ...
        <main className="min-w-0 flex-1">
          <div className="sticky top-0 z-40 border-b border-slate-200 bg-white/90 px-4 py-3 backdrop-blur-xl dark:border-slate-800 dark:bg-[#07122a]/90 lg:hidden">
          ...
          <div className="mx-auto w-full max-w-[1320px] p-4 md:p-8">
            <Outlet />
          </div>
        </main>
      </div>
